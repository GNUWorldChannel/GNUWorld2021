gnuworld@ircd:$ wget https://github.com/GNUWorldChannel/GNUWorld2020/blob/master/gnuworld.tar.gz gnuworld@ircd:$ tar -xvf gnuworld.tar.gz gnuworld@ircd:$ cd gnuworld gnuworld@ircd:/gnuworld$ chmod +x configure
